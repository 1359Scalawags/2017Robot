...
/**
* Initializes a GripAreaPipeline.
*/

namespace grip {

GripAreaPipeline::GripAreaPipeline() {
}
/**
...
*
*/
void GripAreaPipeline::process(cv::Mat source0){
	//Step Resize_Image0:
	//input
 ...
 */
cv::Mat* GripAreaPipeline::getresizeImageOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* GripAreaPipeline::getfindContoursOutput(){
...
std::vector<std::vector<cv::Point> >* GripAreaPipeline::getfilterContoursOutput(){
	 ...
	 */
	void GripAreaPipeline::resizeImage(cv::Mat &input, double width, double height, int interpolation, cv::Mat &output) {
	 ...
	 */
	void GripAreaPipeline::findContours(cv::Mat &input, bool externalOnly, std::vector<std::vector<cv::Point> > &contours) {
	 ...
	 */
	void GripAreaPipeline::filterContours(std::vector<std::vector<cv::Point> > &inputContours, double minArea, double minPerimeter, double minWidth, double maxWidth, double minHeight, double maxHeight, double solidity[], double maxVertexCount, double minVertexCount, double minRatio, double maxRatio, std::vector<std::vector<cv::Point> > &output) {
